...
namespace Quick.ZLMediaKit.HttpApi.Model
{
    ...
    public class ServerConfig
    {
        ...
        public class HookConfig
        {
            ...
            /// 服务器保活
            /// </summary>
            public string On_server_keepalive { get; set; }
            ...
            internal Dictionary<string, object> GetUpdateDicts(HookConfig hookConfig)
            {
                ...
                if (!object.Equals(On_server_keepalive, hookConfig.On_server_keepalive)) dict.Add($"{HookConfig.PrefixName}on_server_keepalive", On_server_keepalive);
